...
HD_PWD='C:/Projects/ERN24004/Projects/PYNQ/04_PMOD_AD1/ad1/ad1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ad1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ad1_wrapper.tcl
