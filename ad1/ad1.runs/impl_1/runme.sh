...
HD_PWD='C:/Projects/ERN24004/Projects/PYNQ/04_PMOD_AD1/ad1/ad1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ad1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ad1_wrapper.tcl -notrace
